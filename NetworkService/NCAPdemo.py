    ...
    if stopic[1] == 'D0C':
        ...
        for mline in rmsg:
            if mline[0]+mline[1]+mline[2] == '211':
                print('211: Read Sensor Data COP')
                ...
                if mline[4] == uuid0: # short[5]
                    if mline[5] == '0x00000000000000000000':
                        ...
                        client.publish(topiccopres, "hogefugapiyo")
                        print("Read TEMP")
