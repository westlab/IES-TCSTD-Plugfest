...
class NtfyDelegate(btle.DefaultDelegate):
    ...
    def handleNotification(self, cHandle, data): 
        ...
        if int((cal[0:2]), 16) == 0xE0:
            ...
            file_path='./data_test/buttery/'+hour_now+".json"
        ...
        if int((cal[0:2]), 16) == 0xf3:
            ...
            file_path='./data_test/environment/'+hour_now+".json"
            ...
            if os.path.isfile(file_path):
                ...
                server_path = 'Sma_Agri/Noken/sonoda/'
                trans_file = './data_save/enironment/'+trans_hour+'.json'
                with open(path_environment + trans_file, 'rb') as f:
                    ftp.storelines(server_path + trans_file, f)
